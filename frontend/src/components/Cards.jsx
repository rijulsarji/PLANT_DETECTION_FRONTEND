      ...
      {props.side % 2 === 0 ? (
        <div className="card">
          ...
          <div className="card-description">
            <h2>Peepal tree</h2>
            <p>
              The peepal tree, also known as Ficus religiosa, is a species of
              fig tree that is considered sacred in many cultures, particularly
              in Hinduism, Buddhism, and Jainism. It is native to the Indian
